...
import userCover from './images/user-cover.jpg';
...
class MyProfile extends React.Component {
    ...
    render() {
        return (
            <div>
            <div className="row" style={{position: "relative",bottom: 5}}>
         <div className="col-12 col-lg-9 mx-auto">
             <img className="img-fluid w-100" src={userCover} style={{height: 300}}></img>
             <img className="img-fluid" src="https://i.pravatar.cc/250" style={{
                 width: 200,
                 height: 200,
                 borderRadius: "50%",
                 position: "absolute",
                 ...
                 color: "white",
                 textAlign: "center"
                 }}>{store.getState().users.filter(user => user.id === parseInt(this.props.match.params.id))[0].name}</h2>
         </div>
         </div>
         <br></br>
         <br></br>
        ...
        <br></br>
         <div className="row">
             ...
             {store.getState().currentUserId === parseInt(this.props.match.params.id)  && <div className="create-post-my-profile">
             <div className="row">
    <div className="col-12 col-lg-9 mx-auto">
    <img className="img-fluid" src="https://i.pravatar.cc/250" style={{width: 70,height: 70,borderRadius: "50%",marginRight: 20}}></img>
             <h4 className="d-inline-block"><Link  style={{color: "white"}}  to={"/profiles/"+store.getState().currentUserId}>{store.getState().users.filter(user => user.id === parseInt(this.props.match.params.id)).map(user =>{ return <span>{user.name}</span>})}</Link>
             </h4>
...
<div className="row">
    ...
    <button class="btn w-100 border-right"  style={{background: "transparent",color: "white"}}>Photo <i class="fas fa-images"></i></button>
        ...
        <br></br>
            ...
            <div className="row">
         <div className="col-12 col-lg-8 mx-auto" style={{padding: 50}}>
         {store.getState().posts[0] && store.getState().posts[0] && store.getState().posts.filter(post => post.userId === parseInt(this.props.match.params.id)).reverse().map(post => {
                    ...
                    <div className="row">
                        ...
                        <img className="img-fluid mx-auto" src="https://i.pravatar.cc/250" style={{width: 70,height: 70,borderRadius: "50%",marginRight: 20}}></img>
                        </div>
<div className="col-9 col-md-10 col-xl-11">
    ...
    <div className="col-4 d-flex justify-content-center" style={{padding: 5}}>
    <button class="btn w-100 border-right"  style={{background: "transparent",color: "white"}}>Comment <i class="fas fa-comment"></i></button>
    </div>
    <div className="col-4 d-flex justify-content-center" style={{padding: 5}}>
    <button class="btn w-100 border-right" style={{background: "transparent",color: "white"}}>Share <i class="fas fa-share"></i></button>
    </div>
    </div>
    </div>
    <br></br>
    ...
    <div className="row">
             ...
             {/* {store.getState().posts[0] && store.getState().posts.filter(post => post.userId === parseInt(this.props.match.params.id)).map(post => {
                    return (<div className="post" key={post.id}>
                <div className="row">
                    <div className="col-3 col-lg-1">
                    <img className="img-fluid" src="https://i.pravatar.cc/350" style={{width: 70,height: 70,borderRadius: "50%",marginRight: 20}}></img>
                    </div>
<div className="col-9 col-lg-11">
                <h4 className="d-inline-block" style={{width: "100%"}}>{store.getState().users[1] && store.getState().users.filter(user => user.id === post.userId)[0].name}
                <p className="d-block" style={{fontSize: 16,color: "grey"}}>{post.date_added}h ago 
                {store.getState().users[1] && 
                <div className="d-inline-block float-right">
                    <span className="float-right"><i class="fas fa-location" style={{marginRight: 5}}></i>
                        <span>{store.getState().users.filter(user => user.id === post.userId)[0].address.street} ,</span>
                        <span>{store.getState().users.filter(user => user.id === post.userId)[0].address.city}</span>
                    </span>
                </div>}
                </p>
                </h4>
...
<button class="btn w-100 border-right border-left" style={{background: "transparent"}} onClick={(event)=>{return this.handleClickLike(event)}}>Love <i class="fa fa-heart" aria-hidden="true"></i></button>
</div>
<div className="col-4 d-flex justify-content-center">
<button class="btn w-100 border-right"  style={{background: "transparent"}}>Comment <i class="fas fa-comment"></i></button>
</div>
<div className="col-4 d-flex justify-content-center">
<button class="btn w-100 border-right" style={{background: "transparent"}}>Share <i class="fa fa-plane" aria-hidden="true"></i></button>
</div>
</div>
</div>
<br></br>
...
{store.getState().comments[0] && store.getState().comments.map(comment => {
    if(comment.postId === post.id){
        ...
        <div className="row" key={comment.id}>
            ...
            <img src={"https://ui-avatars.com/api/?background=0D8ABC&color=fff&name="+comment.email} style={{width: 50,height:50,borderRadius: "50%"}}></img>
                ...
                <div className="col-10 col-lg-11">
            <div style={{backgroundColor: "white",padding: 10,marginBottom: 5,borderRadius: 20}}>
                <p><strong>{comment.email}</strong></p>
                <p>{comment.body.slice(0,40)}</p>
                </div>
            </div>
            </div>
    ...
    <div className="col-12">
    <img className="img-fluid" src="https://i.pravatar.cc/250" style={{width: 70,height: 70,borderRadius: "50%",marginRight: 20}}></img>
             <h4 className="d-inline-block">Heba Assy
             </h4>
    ...
    <div className="row">
    <div className="col-12">
    <textarea className="w-100" style={{borderRadius: 10,padding: 10}} rows="5" placeholder="What's up?"></textarea>
    <br></br>
    <div className="d-block border-top border-bottom">
    <div className="row">
    <div className="col-4 d-flex justify-content-center">
    <button class="btn w-100 border-right"  style={{background: "transparent"}}>Post <i class="fas fa-image"></i></button>
    </div>
    <div className="col-4 d-flex justify-content-center">
    <button class="btn w-100 border-right" style={{background: "transparent"}}>Feeling <i class="fas fa-smile"></i></button>
    </div>
    <div className="col-4 d-flex justify-content-center">
    <button class="btn w-100 border-right border-left" style={{background: "transparent"}}>Live <i class="fas fa-video"></i></button>
    </div>
    </div>
    </div>
    </div>
    ...
    <div className="row">
        ...
        <div className="row">
            <div className="col-12 d-flex justify-content-end">
                <button class="btn btn-primary" onClick={(event)=>{ return this.handleOnClickPost(event) }}>Post</button>
            </div>
        </div>
        <br></br>
        <div className="d-block border-top border-bottom">
            <div className="row">
                ...
                <div className="col-4 d-flex justify-content-center">
    <button class="btn w-100 border-right"  style={{background: "transparent"}}>Photo <i class="fas fa-images"></i></button>
    </div>
                        <div className="col-4 d-flex justify-content-center">
                            <button class="btn w-100 border-right" style={{background: "transparent"}}>Feeling <i class="fas fa-smile"></i></button>
                        </div>
        ...
        <br></br>
             ...
             {!store.getState().currentUserId && <div className="w-100">
                    <h1 className="text-center">Please log-in to post <Link  style={{color: "white"}}  to="/login" style={{textDecoration: "none"}}>Login</Link></h1>
                 </div>}
                 <br></br>
                 <br></br>
